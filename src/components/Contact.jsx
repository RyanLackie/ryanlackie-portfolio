                ...
                <div className="container-fluid">
                    ...
                    <div className="row justify-content-center">
                        ...
                        <div className="col-lg-6 smInputCol">
                            <input className='form-control smInput' placeholder="Your Name" id='name'></input>

                            <input className='form-control smInput' placeholder="Your Email" id='email'></input>

                            <input className='form-control smInput' placeholder="Your Phone #" id='phoneNumber'></input>
                        </div>

                        <div className="col-lg-6 lgInputCol">
                            <textarea className='form-control lgInput' placeholder="Your Message" id='message'></textarea>
                        </div>

                    </div>

                    <div className="buttonContainer">
                        <button className='button' id='button' onClick={this.sendMessage}>
